...
class BacktestComparison(Base):
    ...
    def __init__(self, id_: str = None, correlation: float = None, name: str = None):
        super().__init__()
        self.__id = id_
...
class BacktestRiskPosition(Base):
    @camel_case_translate
    def __init__(self, instrument: dict, quantity: float = None, name: str = None):
        super().__init__()
...
class BacktestSignalSeriesItem(Base):
    ...
    @camel_case_translate
    def __init__(self, date: datetime.date = None, value: bool = None, name: str = None):
        super().__init__()
        self.date = date
        self.value = value
        self.name = name
...
class BaseIndexRefData(Base):
    ...
    @camel_case_translate
    def __init__(self, default: str = None, enum: Tuple[str, ...] = None, name: str = None):
        super().__init__()
...
class HistoricalUnderlier(Base):
    ...
    @camel_case_translate
    def __init__(self, asset_id: str, weight: float = None, date: str = None, name: str = None):
        super().__init__()
        self.asset_id = asset_id
        self.weight = weight
        self.date = date
...
class PerformanceRange(Base):
    ...
    @camel_case_translate
    def __init__(self, horizon: str = None, stats: PerformanceStats = None, name: str = None):
        super().__init__()
...
class VolatilityWeightedWeightingModifierRefData(Base):
    ...
    @camel_case_translate
    def __init__(self, em_aalpha: dict = None, look_back_period: dict = None, name: str = None):
        super().__init__()
        self.em_aalpha = em_aalpha
        self.look_back_period = look_back_period
        self.name = name
...
class BacktestResult(Base):
    ...
    def performance_decompositions(
        self,
    ) -> Tuple[BacktestPerformanceDecomposition, ...]:
