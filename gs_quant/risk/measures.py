...
EqDelta = __risk_measure_with_doc_string(
    "EqDelta", "Equity Delta", RiskMeasureType.Delta, asset_class=AssetClass.Equity
)
EqGamma = __risk_measure_with_doc_string(
    "EqGamma", "Equity Gamma", RiskMeasureType.Gamma, asset_class=AssetClass.Equity
)
...
EqSpot = __risk_measure_with_doc_string(
    "EqSpot", "Equity Spot Level", RiskMeasureType.Spot, asset_class=AssetClass.Equity
)
...
CommodVega = __risk_measure_with_doc_string(
    "CommodVega", "Commodity Vega", RiskMeasureType.Vega, asset_class=AssetClass.Commod
)
...
IRVega = __risk_measure_with_doc_string(
    "IRVega", "Interest Rate Vega", RiskMeasureType.Vega, asset_class=AssetClass.Rates
)
...
CRIFIRCurve = __risk_measure_with_doc_string("CRIFIRCurve", "CRIF IR Curve", RiskMeasureType.CRIF_IRCurve)
...
Description = __risk_measure_with_doc_string("Description", "Description", RiskMeasureType.Description)
Cashflows = __risk_measure_with_doc_string("Cashflows", "Cashflows", RiskMeasureType.Cashflows)
MarketDataAssets = __risk_measure_with_doc_string(
    "MarketDataAssets", "MarketDataAssets", RiskMeasureType.Market_Data_Assets
)
