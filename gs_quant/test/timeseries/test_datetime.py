...
def test_align():
    ...
    a = pd.Series(
        [0, 100, 110],
        index=pd.DatetimeIndex(["2019-07-01", "2019-07-08", "2019-07-10"]),
    )
...
def test_prepend():
    ...
    expected = pd.Series(
        [1.0, 2.0, 3.1, 4.1, 5.1],
        index=pd.date_range("2019-01-01", periods=5, freq="H"),
    )
